...
class GasItemsPage extends StatefulWidget {
  GasItemsPage({Key? key, required this.pgImg}) : super(key: key);
  final pgImg;
  @override
  _GasItemsPageState createState() => _GasItemsPageState();
}

class _GasItemsPageState extends State<GasItemsPage> {
