...
class PhoneGoodsPage extends StatefulWidget {
  PhoneGoodsPage({Key? key, required this.pgImg}) : super(key: key);
  final pgImg;
  @override
  _PhoneGoodsPageState createState() => _PhoneGoodsPageState();
}

class _PhoneGoodsPageState extends State<PhoneGoodsPage> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Container(
                    child: phonebottomWidget(context, pgImg, serviceController),
                  ),
                  Container(
                    height: 60,
                  )
