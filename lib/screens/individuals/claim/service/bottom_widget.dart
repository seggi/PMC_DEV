...
import 'claim/service_claim1_page.dart';
        ...
        child: TextButton(
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => ServiceClaimPageOne()));
          },
          child: Text(
            "Next page",
            style: TextStyle(
...
List<Widget> customFields = [
  formField('Your names'),
  Divider(
    thickness: 1,
    height: 10,
    color: Colors.transparent,
  ),
  formField('Your address'),
  Divider(
    thickness: 1,
    height: 10,
    color: Colors.transparent,
  ),
  formField('Your phone'),
  Divider(
    thickness: 1,
    height: 10,
    color: Colors.transparent,
  ),
  formField('Your email'),
  Divider(
    thickness: 1,
    height: 10,
    color: Colors.transparent,
  ...
  formFieldMultLine("Describe your claim"),
  Divider(
    thickness: 1,
    height: 50,
    color: Colors.transparent,
